...
//////////////////////////////////////////////////////////////////////////////////////////////
//
//  COMPUTE THE OVERLAP MATRIX BETWEEN TWO ATOMS
//
//////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////
//
//  compute overlap between two atomic orbitals
//
//////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////
//
// Additional function for overlap between AO
//
//////////////////////////////////////////////////////////////////////////////////////////////
...
void compute_huckel_hamiltonian_general(double *hmat, double *smat, int nb_orb_precomp, char *file_name)
{
  ...
  // compute the Hamoltonian and overlap
	...
	for(i=0;i<no_atoms;i++)	
	{
		...
		// increment the # of total orbitals  
		norb_tot += noorb_i;  		  
